...
public abstract class LineAxis extends AbstractDisplayAxis {
	...
	/**
	 * このクラスは、折れ線グラフの水平軸情報を保持するクラスです。
	 * 
	 * @since 1.0.0
	 * @version 1.0.0 2014/06/25
	 * @author Kawakicchi
	 */
	public static class LineHorizontalAxis extends LineAxis {

		/**
		 * コンストラクタ
		 */
		public LineHorizontalAxis() {
		}

	}

	/**
	 * このクラスは、折れ線グラフの垂直軸情報を保持するクラスです。
	 * 
	 * @since 1.0.0
	 * @version 1.0.0 2014/07/02
	 * @author Kawakicchi
	 */
	public static class LineVerticalAxis extends LineAxis {
