 ...
 * @author Kawakicchi
 */
public class PolarLooks extends AbstractLooks {
	...
	public Marker getSeriesMarker(final int aIndex, final PolarSeries aSeries) {
		Marker marker = null;
		switch (aIndex % 4) {
		case 0:
	...
	public Marker getSeriesPointMarker(final int aIndex, final PolarSeries aSeries, final int aNo, final PolarSeriesPoint aPoint) {
		return null;
	}
}
