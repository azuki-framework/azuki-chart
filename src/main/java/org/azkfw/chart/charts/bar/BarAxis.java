...
/**
 * このクラスは、棒グラフの軸情報を保持するクラスです。
 * 
 * @since 1.0.0
 * @version 1.0.0 2014/06/25
 * @author Kawakicchi
 */
public abstract class BarAxis extends AbstractDisplayAxis {
	...
	/**
	 * このクラスは、棒グラフの水平軸情報を保持するクラスです。
	 * 
	 * @since 1.0.0
	 * @version 1.0.0 2014/06/25
	 * @author Kawakicchi
	 */
	public static class BarHorizontalAxis extends BarAxis {

		/**
		 * コンストラクタ
		 */
		public BarHorizontalAxis() {
		}

	}

	/**
	 * このクラスは、棒グラフの垂直軸情報を保持するクラスです。
	 * 
	 * @since 1.0.0
	 * @version 1.0.0 2014/06/25
	 * @author Kawakicchi
	 */
	public static class BarVerticalAxis extends BarAxis {
