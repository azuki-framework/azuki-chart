 ...
 * @author Kawakicchi
 */
public class RadarLooks extends AbstractLooks {
	 ...
	 * @return ストローク
	 */
	public Stroke getSeriesStroke(final int aIndex, final RadarSeries aSeries) {
	 ...
	 * @return カラー
	 */
	public Color getSeriesStrokeColor(final int aIndex, final RadarSeries aSeries) {
		Color color = null;
	 ...
	 * @return カラー
	 */
	public Color getSeriesFillColor(final int aIndex, final RadarSeries aSeries) {
