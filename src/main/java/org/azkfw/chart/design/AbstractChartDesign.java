...
public abstract class AbstractChartDesign<STYLE extends ChartStyle> implements ChartDesign<STYLE> {
	...
	/** デフォルト 軸目盛ラベルフォント */
	// private final static Font DEFAULT_FONT_AXIS_SCALE_LABEL = new Font("Arial", Font.BOLD, 12);
	private final static Font DEFAULT_FONT_AXIS_SCALE_LABEL = new Font("MS ゴシック", Font.BOLD, 12);
	/** デフォルト 軸目盛ラベルカラー */
